	...
	public void action() {  
		...
		if (messageReceived != null) { 
			...
			if ( messageReceived.getPerformative() == ACLMessage.INFORM ) { 
				...
				//Avant de s'endormir, l'ordonnanceur doit vÈrifier sa liste de message !
				...
				while(messageReceived != null){
					...
					if (messageReceived.getPerformative() == ACLMessage.INFORM_REF){ //Un joueur a fait faillite
						...
						Logger.info(proprietaire.getLocalName() + " est dÈsormais proprietaire de " + propriete.getNom());
				...
				System.err.println("OrdonnanceurBehaviour a reÁu un message qu'il n'a pas compris !");
			}
		...
		try {
			...
			if ( reply != null ) {
				if ( reply.getPerformative() == ACLMessage.CONFIRM ) { 
					...
					System.err.println("OrdonnanceurBehaviour a reÁu un message au mauvais moment : " + 
